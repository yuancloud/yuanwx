...
class Ewei_scratchModule extends WeModule {
    ...
    public function fieldsFormDisplay($rid = 0) {
        ...
        if (!$reply) {
            ...
            $reply = array(
             "title"=>"刮刮卡活动开始了!",
			  "start_picurl"=>"../addons/ewei_scratch/style/image/activity-scratch-card-start.jpg",
			  ...
			  "end_picurl"=>"../addons/ewei_scratch/style/image/activity-scratch-card-end.jpg",
			  "most_num_times"=>1,
			  "number_times"=>1,
			  "probability"=>0,
			  "award_times"=>1,
    ...
    public function ruleDeleted($rid) {
        pdo_delete('ewei_scratch_award', array('rid' => $rid));
        pdo_delete('ewei_scratch_reply', array('rid' => $rid));
        pdo_delete('ewei_scratch_fans', array('rid' => $rid));
    }
