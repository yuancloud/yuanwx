		...
		<form action="" method="post" class="form-horizontal form" onsubmit="return formcheck(this)" id="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-10 col-xs-12">
					...
					<div class="help-block">SMTP服务器为发送邮件的服务器，微赞程序内置了163的邮件服务器的信息，可直接使用。如果有特殊需要请自定义SMTP服务器</div>	
				</div>
			</div>
			...
			<label class="radio-inline"><input type="radio" name="sms[type]" value="yimei" <?php  if($_W['setting']['sms']['type'] == "yimei" || empty($_W['setting']['sms']['type'])) { ?> checked<?php  } ?> /> 亿美 (<a href="http://www.emay.cn/" target="_blank">http://www.emay.cn/</a>)</label>
                                                      <label class="radio-inline"><input type="radio" name="sms[type]" value="dxton" <?php  if($_W['setting']['sms']['type'] == "dxton" || empty($_W['setting']['sms']['type'])) { ?> checked<?php  } ?> /> 短信通（推荐） (<a href="http://www.dxton.com/" target="_blank">http://dxton.com/</a>)</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-10 col-xs-12">
					...
					<div class="help-block">如果收到 “您的验证码是：【专注中小企业信息化和互联网+】。如需帮助请联系客服。”，说明接口可用</div>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-xs-12 col-sm-10 col-md-10 col-lg-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10 col-xs-12">
					...
					<div class="help-block">升级“微赞”系统时，需要先删除升级锁，确保升级正常进行。</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10 col-xs-12">
					...
					<div class="help-block">重新安装“微赞”系统时，需要先删除安装锁。</div>
				</div>
			</div>
		</form>
	</div>
