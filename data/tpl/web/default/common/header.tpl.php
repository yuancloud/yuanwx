	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://www.yuancloud.cn"><i class="fa fa-comment"></i>YuanWX论坛</a></li>
				<li><a href="http://www.yuancloud.cn"><i class="fa fa-comment"></i>专注中小企业信息化和互联网+</a></li>
				<?php  } ?>
			</ul>
		...
		<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<?php  if(IMS_FAMILY != 'x') { ?>
						<li><a href="http://www.yuancloud.cn"><i class="fa fa-comment"></i>YuanWX论坛</a></li>
						<li><a href="http://www.yuancloud.cn"><i class="fa fa-suitcase"></i>专注中小企业信息化和互联网+</a></li>
					<?php  } ?>
				</ul>
				<ul class="nav navbar-nav navbar-right">
