	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="z-index:1001; margin-bottom:0;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://www.yuancloud.cn" target="_blank" title="一键更新授权后，更新一次，会自动去掉此处和所有版权信息"><i class="fa fa-comment"></i>专注中小企业信息化和互联网+</a></li>
				<li><a href="http://www.yuancloud.cn" target="_blank" title="一键更新授权后，更新一次，会自动去掉此处和所有版权信息"><i class="fa fa-suitcase"></i>帮助</a></li>
				<?php  } ?>
			</ul>
